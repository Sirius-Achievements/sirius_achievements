        ...
        chartRef.current = new Chart(canvas.getContext('2d')!, {
          ...
          data: {
            ...
            datasets: [{
              ...
              borderColor: cssVar('--theme-accent', '#4f46e5'),
              backgroundColor: dark() ? 'rgba(129, 140, 248, 0.16)' : 'rgba(79, 70, 229, 0.08)',
              fill: true,
              tension: 0.3,
              borderWidth: 2,
              pointBackgroundColor: cssVar('--theme-surface', '#ffffff'),
              pointBorderColor: cssVar('--theme-accent-strong', '#4338ca'),
              pointRadius: 3,
              pointHoverRadius: 6,
            }],
          },
