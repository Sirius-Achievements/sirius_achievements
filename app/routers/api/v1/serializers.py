...
def serialize_achievement(achievement):
    ...
    return {
        ...
        'season_id': getattr(achievement, 'season_id', None),
        'event_date': getattr(achievement, 'event_date', None).isoformat() if getattr(achievement, 'event_date', None) else None,
        'submitted_at': _iso(getattr(achievement, 'submitted_at', None)),
        'eligible_for_ranking': bool(getattr(achievement, 'eligible_for_ranking', True)),
        'season_disposition': getattr(achievement, 'season_disposition', None),
